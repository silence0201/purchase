		...
		<div id = "main_div">
			<header class="supportInfo">
				<h3>删除供应商</h3>
					...
					<div class="form">
					<h3 style="text-align: center;">请确认供应商信息</h3>
					<hr />
					<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
					...
					<form action="">
						...
						<input type="text" id="contacts" name="contacts" readonly="readonly">
						<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<label for="telnumber">联系电话&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<input type="text" id="telnumber" name="telnumber" readonly="readonly">
