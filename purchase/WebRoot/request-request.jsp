...
<jsp:useBean id="statistics" class="request.Statistics" scope="page"></jsp:useBean>
<%
	...
	<section id="main">
		...
		<div id="side_div2">
			 ...
			 <%
			 	 ...
			 	 out.println("累计申请次数:"+statistics.getCount()+"<br>");
			 	 //此处显示的是不论申请单通过与否还是未审核的累计金额，若仅显示通过的累计金额则用statistics.getRealAccount()
			 	 out.println("累计申请金额:"+statistics.getRequestAccount()+"<br>");
			 	 out.println("本月剩余金额:"+statistics.getRemainAccount()+"<br>");
			 	 //以下代码参数为提交一次申请单的总金额
			 	 //statistics.setStatistics(account);
			 	 //每月1号重置数据
			 	 //Date dnow = new Date(); 
