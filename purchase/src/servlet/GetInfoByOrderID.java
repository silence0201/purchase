...
public class GetInfoByOrderID extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "SELECT `demand`.`ItemID`,`demand`.`Number`,`demand`.`Account`,`item`.`Unitprice`,`order`.`orderManID`,`order`.`Statement` "
		...
		try {
			while(rs!=null&&rs.next()){
				...
				s=itemID+","+price+","+number+","+account+","+orderManID +","+ status ;
			}
